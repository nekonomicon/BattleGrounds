...
public:
	void Spawn( void );
	void EXPORT TriggerUse(CBaseEntity *pActivator, CBaseEntity *pCaller, USE_TYPE iUseType, float flValue) { 
		if(pActivator && (pev->team == UNDEFINED && pev->team == pActivator->pev->team)) 
			SUB_UseTargets( pActivator, iUseType, flValue ); }
};
